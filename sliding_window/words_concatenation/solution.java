...
class WordConcatenation {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(result);
    result = WordConcatenation.findWordConcatenation("ugbugdogbug", new String[] { "bug", "dog" });
    System.out.println(result);
    result = WordConcatenation.findWordConcatenation("rofootrooffoot", new String[] { "roof", "foot", "foot" });
    System.out.println(result);
  }
}
